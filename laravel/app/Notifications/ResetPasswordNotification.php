   ...
   /**
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject(Lang::get('Solicitud restablecimiento de contraseña'))
            ...
            ->line(Lang::get('Si no solicitó un restablecimiento de contraseña, favor no realizar ninguna acción.'))
            ->line(Lang::get('!Saludos!'));
    }
