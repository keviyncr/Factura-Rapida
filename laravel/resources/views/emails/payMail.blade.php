                            ...
                            <td class="header">
                                <a href="{{ config('app.url') }}">
                                    <div class="footer-brand">
                                        <span class=""><img src="https://facturarapida.net/frontend/img/logoFR-2.png" width="200" alt="Factura Rapida"></span>
                                    </div>
                                </a>
                            </td>
                        </tr>
                            ...
                            <td class="body" width="100%" cellpadding="0" cellspacing="0">
                                <table class="inner-body" align="center" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                    ...
                                    <tr>
                                        ...
                                        El pago <strong>N°{{ $msg['number'] }}</strong> para la suscripción al sistema de Factura Rápida fue realizado con éxito, el codigo de verificación para el registro de su compañia es: <strong>{{ $msg['code'] }}.</strong> 
                                        <br>
                                        Este codigo es único y funciona para el registro de una sola compañia.
                                           <br>
                                           <strong>No compartir este código.</strong>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                ...
                                <table class="footer" align="center" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="content-cell" align="center">
                                            ...
                                            <br>
                                            Correo generado automaticamente no contestar a este mensaje.
                                        </td>
                                    </tr>
                                </table>
                            </td>
