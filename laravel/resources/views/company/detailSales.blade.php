...
<div class="profile">
    <div class="profile-header">
        ...
        <div class="profile-header-content" style="background-color:black;">
            <form data-parsley-validate="true" action="{{ url('/dSales') }}" method="POST">
        ...
        <table id="data-table-report" class="table-striped table-bordered table-td-valign-middle" width="100%">
            <thead>
                <tr>
                    ...
                    <th width="13%" data-orderable="false">Emisor</th>
                    <th width="15%" data-orderable="false">Item</th>
                    ...
                    <th width="10%" data-orderable="false">Estado MH</th>
                </tr>
            </thead>
            <tbody>
                @if(isset($detail))
                    @foreach($detail as $index=>$line)
                        <tr class="gradeU">
                            ...
                            <td width="19%" >{{ $line["item"] }}</td>
                            <td width="7%" class="text-center">{{ $line["monto"] }}</td>
                            <td width="7%" class="text-center">{{ $line["discount"] }}</td>
                            <td width="7%" class="text-center">{{ $line["tax"] }}</td>
                            <td width="7%" class="text-center">{{ $line["total"] }}</td>
                            <td width="7%" class="text-center">{{ $line["tmoneda"] }}</td>
                            <td width="7%" class="text-center">{{ $line["typeTax"]."%" }}</td>
                            <td width="8%" class="text-center">{{ $line["ae"] }}</td>
                            <td width="8%" class="text-center">{{ $line["state"] }}</td>
                        </tr>
                    @endforeach
                @endif
             ...
             <tfoot>
                 @if(isset($detail))
                    <tr>
                      ...
                      <td></td>
                      <td>Totales</td>
                      <td width="7%" class="text-center">{{ $sumaMonto }}</td>
                      <td width="7%" class="text-center">{{ $sumaDescuento }}</td>
                      <td width="7%" class="text-center">{{ $sumaImpuesto }}</td>
                      <td width="7%" class="text-center">{{ $sumaTotal }}</td>
                      <td></td>
                    </tr>
                @endif
              </tfoot>
