...
<div class="panel panel-inverse" data-sortable-id="form-plugins-1">
    ...
    <div class="panel-heading">
        ...
        <div class="panel-heading-btn">
            <a href="#modal-addDiscount"  data-toggle="modal" title="Nuevo descuento" class="btn btn-md btn-icon btn-circle btn-danger"><i class="fa fa-plus"></i></a>
        ...
        <table id="data-table-discounts" class="table table-striped table-bordered table-td-valign-middle">
            <thead>
                <tr>
                    ...
                    <th width="12%" class="text-nowrap">Naturaleza</th>
            ...
            <div class="modal-body">
                <form data-parsley-validate="true" action="{{ url('/discounts') }}" method="POST" name="add_discount" id="add_discount" class="form-horizontal form-bordered">
                    ...
                    <div class="form-group row m-b-10">
                        <label class="col-lg-3 col-form-label">Naturaleza del descuento: <span class="text-danger"></span></label>
                        <div class="col-lg-9 col-xl-9">
                            <input type="text" name="nature" data-parsley-required="true" class="form-control" placeholder="Naturaleza del descuento" />
                        </div>                       
                    </div>
                    <!-- end form-group -->
                    <!-- begin form-group -->
                    <div class="form-group row m-b-10">
                        <label class="col-lg-3 col-form-label">Monto del descuento: <span class="text-danger"></span></label>
                        <div class="col-lg-9 col-xl-9">
                            <input data-toggle="number" data-placement="after" class="form-control" type="number"  name="amount" id="amount"  step='0.00001' value='0.00000' placeholder='0.00000'   data-parsley-required="true"  />
                        </div>                       
                    </div>
                    <!-- end form-group -->                     
                </form>
...
<!-- #modal-addClient -->
<!-- #modal-updateClient -->
<div class="modal fade" id="modal-updateDiscount">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Actualizar decuento</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <form data-parsley-validate="true" action="{{ url('/discounts') }}" method="POST" name="update_discount" id="update_discount" class="form-horizontal form-bordered">
                    @csrf
                    @method('PATCH')
                    <!-- begin form-group -->
                    <div class="form-group row m-b-10">
                        <label class="col-lg-3 col-form-label">Naturaleza del descuento <span class="text-danger"></span></label>
                        <div class="col-lg-9 col-xl-9">
                            <input type="text" name="nature" id="natureU" data-parsley-required="true" class="form-control" placeholder="Naturaleza del descuento" />
                    ...
                    <div class="form-group row m-b-10">
                        <label class="col-lg-3 col-form-label">Monto del descuento: <span class="text-danger"></span></label>
                        <div class="col-lg-9 col-xl-9">
                            <input data-toggle="number" data-placement="after" class="form-control" type="number"  name="amount" id="amountU"  step='0.00001' value='0.00000' placeholder='0.00000'   data-parsley-required="true"  />
                        </div>                       
                    </div>
                    <!-- end form-group -->    
                </form>
            ...
            <div class="modal-footer">
                <a href="javascript:;" class="btn btn-white" data-dismiss="modal">Cerrar</a>
                <button type="submit" form="update_discount" class="btn btn-success">Actualizar</button>
