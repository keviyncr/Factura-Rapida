...
<div class="profile">
    <div class="profile-header">
        ...
        <div class="profile-header-conver">
            <h4 class="panel-title">Reporte de Ingresos y Gastos</h4>
        </div>
        <!-- END profile-header-cover -->
        <!-- BEGIN profile-header-content -->
        <div class="profile-header-content" style="background-color:black;">
            <form data-parsley-validate="true" action="{{ url('/profitAndLost') }}" method="POST">
...
<div class="panel panel-inverse" data-sortable-id="form-plugins-1">
    ...
    <div class="panel-body" width="100%" style="font-size:10px">
        <table id="data-table-report" class="table-striped table-bordered table-td-valign-middle" width="100%">
            <thead>
                <tr>
                    <th width="7%"data-orderable="false" class="FontSmall">Fecha</th>
                    <th width="15%" data-orderable="false" class="text-sm-center">Numero Factura</th>
                    <th width="13%" data-orderable="false" class="text-sm-center">Emisor</th>
                    <th width="15%" data-orderable="false" class="text-sm-center">Item</th>
                    <th width="7%" data-orderable="false" class="text-sm-center">Monto</th>
                    <th width="7%" data-orderable="false" class="text-sm-center">Descuento</th>
                    <th width="7%" data-orderable="false" class="text-sm-center">Impuesto</th>  
                    <th width="7%" data-orderable="false" class="text-sm-center">Total</th> 
                    <th width="7%" data-orderable="false" class="text-sm-center">Moneda</th> 
                    <th width="10%" data-orderable="false" class="text-sm-center">Tipo Impuesto</th>
                    <th width="10%" data-orderable="false" class="text-sm-center">Act. Econom.</th>
                    <th width="10%" data-orderable="false" class="text-sm-center">Estado MH</th>
                </tr>
            </thead>
            <tbody>
                @if(isset($detail))
                    @foreach($detail as $index=>$line)
                        <tr class="gradeU">
                            <td width="15%" class="text-sm-center">{{ $line["fecha"] }}</td>
                            <td width="15%" class="text-sm-center">{{ $line["clave"] }}</td>
                            <td width="15%" class="text-sm-left">{{ $line["receptor"] }}</td>
                            <td width="19%" class="text-sm-left">{{ $line["item"] }}</td>
                            <td width="7%" class="text-sm-center">{{ $line["monto"] }}</td>
                            <td width="7%" class="text-sm-center">{{ $line["discount"] }}</td>
                            <td width="7%" class="text-sm-center">{{ $line["tax"] }}</td>
                            <td width="7%" class="text-sm-center">{{ $line["total"] }}</td>
                            <td width="7%" class="text-sm-center">{{ $line["tmoneda"] }}</td>
                            <td width="7%" class="text-sm-center">{{ $line["typeTax"]."%" }}</td>
                            <td width="8%" class="text-sm-center">{{ $line["ae"] }}</td>
                            <td width="8%" class="text-sm-center">{{ $line["state"] }}</td>
                        </tr>
                    @endforeach
                @endif
             ...
             <tfoot>
                 @if(isset($detail))
                    <tr>
                      ...
                      <td></td>
                      <td>Totales</td>
                      <td width="7%" class="text-sm-center">{{ $sumaMonto }}</td>
                      <td width="7%" class="text-sm-center">{{ $sumaDescuento }}</td>
                      <td width="7%" class="text-sm-center">{{ $sumaImpuesto }}</td>
                      <td width="7%" class="text-sm-center">{{ $sumaTotal }}</td>
                      <td></td>
                    </tr>
                @endif
              </tfoot>
        ...
        <table id="data-table-report" class="table-striped table-bordered table-td-valign-middle" width="100%">
            <thead>
                <tr>
                    ...
                    <th width="10%" data-orderable="false">Numero Factura</th>
                    <th width="10%" data-orderable="false">Emisor</th>
                    <th width="10%" data-orderable="false">Item</th>
                    ...
                    <th width="10%" data-orderable="false">Tipo Impuesto</th>
                    <th width="10%" data-orderable="false">Categoria</th>
                    <th width="5%" data-orderable="false">Act. Econom.</th>
                    <th width="5%" data-orderable="false">Condicion</th>
                </tr>
            </thead>
            <tbody>
                @if(isset($detailG))
                    @foreach($detailG as $index2=>$lineG)
                        <tr class="gradeU">
                            <td width="10%" class="text-sm-center">{{ $lineG["fechaG"] }}</td>
                            <td width="10%" class="text-sm-center">{{ $lineG["claveG"] }}</td>
                            <td width="10%" class="text-sm-left">{{ $lineG["emisor"] }}</td>
                            <td width="10%" class="text-sm-left">{{ $lineG["itemG"] }}</td>
                            <td width="5%" class="text-sm-center">{{ $lineG["montoG"] }}</td>
                            <td width="5%" class="text-sm-center">{{ $lineG["discountG"] }}</td>
                            <td width="5%" class="text-sm-center">{{ $lineG["taxG"] }}</td>
                            <td width="5%" class="text-sm-center">{{ $lineG["totalG"] }}</td>
                            <td width="5%" class="text-sm-center">{{ $lineG["tmoneda"] }}</td>
                            <td width="5%" class="text-sm-center">{{ $lineG["typeTaxG"]."%" }}</td>
                            <td width="10%" class="text-sm-center">{{ $lineG["category"] }}</td>
                            <td width="8%" class="text-sm-center">{{ $lineG["aeG"] }}</td>
                            <td width="8%" class="text-sm-center">{{ $lineG["condition"] }}</td>
                        </tr>
                    @endforeach
                @endif
             ...
             <tfoot>
                 @if(isset($detailG))
                    <tr>
                      ...
                      <td>Totales</td>
                      <td>{{ $sumaMontoG }}</td>
                      <td width="5%" class="text-sm-center">{{ $sumaDescuentoG }}</td>
                      <td width="5%" class="text-sm-center">{{ $sumaImpuestoG }}</td>
                      <td width="8%" class="text-sm-center">{{ $sumaTotalG }}</td>
                      <td></td>
                    </tr>
                @endif
              </tfoot>
...
<div class="panel panel-inverse" data-sortable-id="form-plugins-1">
    <!-- begin panel-heading -->
    <div class="panel-heading">
       <h4 class="panel-title">Ganancias</h4>
    ...
    <div class="panel-body" width="100%" style="font-size:10px">
        <table id="data-table-report" class="table-striped table-bordered table-td-valign-middle" width="100%">
            <thead>
                <tr>
                    <th width="40%"data-orderable="false">Descripcion</th>
                    <th width="15%"data-orderable="false">Subtotal</th>
                    <th width="15%" data-orderable="false">Descuentos</th>
                    <th width="15%" data-orderable="false">Impuestos</th>
                    <th width="15%" data-orderable="false">Total</th>
                </tr>
            </thead>
            <tbody>
                @if(isset($detailG))
