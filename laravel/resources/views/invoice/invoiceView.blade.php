...
<html lang="en">
    ...
    <body>
        ...
        <header class="clearfix">   
            ...
            <div id="company" >       
                 <h4 class="name">{{ $client->name_provider }}</h4>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="unit">{{ $detail[2] }}</td>
                    <td class="qty">{{ $detail[3] }}</td>
                    <td class="price">{{ $detail[4] }}</td>
                    <td class="discount">{{ $detail[5] }}</td>
                    <td class="tax">{{ $detail[6] }}</td>
                    <td class="exo">{{ $detail[7] }}</td>
                    <td class="total">{{ $detail[8] }}</td>
                </tr>
                @endforeach
